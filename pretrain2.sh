...
do
 python train.py --dataset 'OntoNotes' --split_val 1 --train_type 'train' --cluster_rep 'box' --cluster2box 'R2B2' \
          ...
          --proj_ins2type 1 --match_weight 0 --cross_IoU_margin 0.5 --onlyBottom 1 --use_type_emb 0 --init_type 1 --type_emb_method 'B4T' --cross_dynamic_weight 1 --type_IoU_margin 0.5 --enable_type_desc 1 --cross_weight $ins_margin --enable_cross_pb 0
done
