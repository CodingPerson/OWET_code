...
#done
for ins_margin in 0.05 0.15 0.2 0.25
do
    python train.py --dataset 'OntoNotes' --split_val 1 --train_type 'train' --cluster_rep 'box' --cluster2box 'R2B2' \
          ...
          --pretrain_path "log/OntoNotes-_sup+mlm_val_HAC+HDBSCAN+1e-4Type_taxo0.01+-0.01_aver_cp_128_newdesc/checkpoint_OntoNotes_lr_2e-05_latest.pth" \
          --single_box_model 0 --margin 10 --lr_box 1e-4 --alpha 1 --mini_ins_size 0.1 --mini_type_size 0.5 --dist_type 'BoxE' --box_self_adv 1 \
          ...
          --type_taxo_extra $ins_margin --type_taxo_alpha 1.0 --cross_taxo_extra $ins_margin --cross_taxo_alpha 1.0 --box_inter_start -1 --cross_inter_start -1 --type_taxo_eps -0.01 --type_taxo_margin 0.01 --cross_taxo_eps -0.01 --cross_taxo_margin 0 --type_inter_type 'taxo' --cross_inter_type 'taxo' --gen_box_method 'mlp' --type_box_dim 128 \
